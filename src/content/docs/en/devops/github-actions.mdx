...
- Inside the *`Dockerfile`*, paste
  ...
  <Gist gistCode="d2ad0392ddaa67e75609fd09e65a83e2" fileName="Dockerfile" />
...
- Inside the *`entrypoint.sh`*, paste
  ...
  <Gist gistCode="d2ad0392ddaa67e75609fd09e65a83e2" fileName="entrypoint.sh" />
...
- Inside it, paste
  ...
  <Gist gistCode="d2ad0392ddaa67e75609fd09e65a83e2" fileName="action.yml" />
...
- As a part of this branch and pull request, edit *`.github/workflows/main.yml`* to append the following content:
  ...
  <Gist gistCode="d2ad0392ddaa67e75609fd09e65a83e2" fileName="main.yml" />
