...
<Gist gistCode="e97375f8dcca6e4296b135e0588266d4" fileName="basic-app.js" />
...
<Gist gistCode="e97375f8dcca6e4296b135e0588266d4" fileName="styles.js" />

This specific `container` styling is then called using the following format:

<Gist gistCode="e97375f8dcca6e4296b135e0588266d4" fileName="view.js" />
...
<Gist gistCode="e97375f8dcca6e4296b135e0588266d4" fileName="platform.js" />
...
- [React Native Path Aliasing with @](https://javascript.plainenglish.io/react-native-path-aliasing-with-simplify-your-imports-and-enhance-your-codebase-9897efee96a8)
- [Routing and navigation for Expo and React Native apps](https://reactnavigation.org)
