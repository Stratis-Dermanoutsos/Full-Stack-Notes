...
- [ ] Frontend
  - [x] Basics
    - [x] ***HTML*** ([notes](./Frontend/HTML/#html---notes) and [resources](./Frontend/HTML/#html---resources))
      - [x] Form and Validations
      - [x] Semantic and non-semantic ***HTML***
    - [x] ***CSS*** ([notes](./Frontend/CSS/#css---notes) and [resources](./Frontend/CSS/#css---resources))
      - [x] Prefixes
      - [x] Positions
      - [x] Display (**Flex**, **Grid**)
      - [x] Responsive design
...
- [ ] Backend
  ...
  - [ ] ***ASP .NET*** (***C#***) or
    ...
    - ***Ruby on Rails*** (***Ruby***)
    - ***Flask*** (***Python***)
  - [x] Databases ([notes](#databases---notes) and [resources](#databases---resources))
    - [x] ***MySQL***
    - [x] ***SQLite***
    - [x] ***PostgreSQL***
    - [x] ***MongoDB***
