...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-define.js" />
...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-define-button.js" />
...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-components-panel.js" />
...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-requires.js" />
...
- **Classic**: The **Classic** toolkit is ***Ext JS***'s original toolkit, and is designed for building traditional, "*desktop-style*" web applications.
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="sencha-generate-classic.sh" />
...
- **Modern**: The **Modern** toolkit is a newer addition to ***Ext JS***, and is designed for building modern, "*mobile-first*" web applications.
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="sencha-generate-modern.sh" />
...
- **Universal**: The **Universal** toolkit is a combination of the **Classic** and **Modern** toolkits, and is designed to support applications that need to run on both desktop and mobile devices.
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="sencha-generate-universal.sh" />
...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-layouts.js" />
...
- `border`
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-layouts-border.js" />
...
- `card`
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-layouts-card.js" />

- `fit`

  This is a base class for layouts that contain a single item that automatically expands to fill the layout's container.

  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-layouts-fit.js" />

- `hbox`

  A layout that arranges items horizontally across a `Ext.container.Container`.

  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-layouts-hbox.js" />

  It is basically the same as using the following ***CSS*** in an ***HTML***'s div:

  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-layouts-hbox.css" />

- `vbox`

  A layout that arranges items vertically across a `Ext.container.Container`.

  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-layouts-vbox.js" />

  It is basically the same as using the following ***CSS*** in an ***HTML***'s div:

  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-layouts-vbox.css" />
...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-store.js" />

What we did, is create a store that holds 4 instances/objects of the User `model`.

> The model can be defined as such:
>
> <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-store-model.js" />
...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-store-inheritance.js" />
...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-store-sort.js" />

- Property

  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-store-sort-property.js" />

- Method

  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-store-sort-method.js" />
...
- Property
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-store-filter-property.js" />

- Method

  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-store-filter-method.js" />
...
1. Go to your `Application.js` file and, inside the class definition, add the following:
   ...
   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-store-global.js" />

2. In your store, provide a `storeId` attribute, usually the same as the `alias`.

   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-storeId.js" />
...
1. Gerenate your first project
   ...
   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-npm-gen-app.sh" />

2. Run the app

   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="ext-npm-start.sh" />
...
2. Run the app
   ...
   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="sencha-app-watch.sh" />

## Build your App

1. Clean the current build

   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="sencha-app-clean.sh" />

2. Build

   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="sencha-app-build.sh" />
...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="sencha-package.json" />
