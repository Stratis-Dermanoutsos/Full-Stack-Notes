...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-extensions.cs" />

To call this method now, there are 2 simple ways.

<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-extensions-demo.cs" />

## Null-Coalescing Operator

The `??` operator will return the value of its left-hand operand if it is not *null*. Else, it returns the right one.

<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-null-coalescing-1.cs" />

<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-null-coalescing-2.cs" />
...
<Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-null-coalescing-operator.cs" />
...
1. **Generic methods** allow you to define a method that can work with different types of data. You can specify the data type when you call the method.
   ...
   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-generic-method.cs" />

   When you call it, the output of the program heavily relies on the type of the parameter provided.

   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-generic-method-demo.cs" />
...
2. You can define a **generic method** using the `<T>` syntax, where `T` is a type parameter that represents the type of data you want to work with.
   ...
   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-generic-method-typed.cs" />

   Now, with the same input, we get similar but not the same results.

   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-generic-method-typed-demo.cs" />
...
3. When calling a **generic method**, you can either *specify the type parameter explicitly* (e.g. `MyMethod<int>(5)`) or *let the compiler infer the type parameter based on the arguments* you pass to the method (e.g. `MyMethod(5)`).
   ...
   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-generic-method-default-type.cs" />
...
4. **Generic methods** can be used to create extension methods that work with any type that meets certain criteria, such as implementing a specific interface.
   ...
   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-generic-method-typed-extension.cs" />
   ...
   <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="csharp-generic-method-typed-extension-demo.cs" />
