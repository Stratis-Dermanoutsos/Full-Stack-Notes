...
- Inside the *`Dockerfile`*, paste
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="gh-actions-Dockerfile" />
...
- Inside the *`entrypoint.sh`*, paste
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="gh-actions-entrypoint.sh" />
...
- Inside it, paste
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="gh-actions-action.yml" />
...
- As a part of this branch and pull request, edit *`.github/workflows/main.yml`* to append the following content:
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="gh-actions-main.yml" />
