...
- Create an ***API*** (***C\#***)
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="dotnet-new-webapi.sh" />
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="api-weather-data.json" />
...
- Access data through ***API*** (***JavaScript***)
  ...
  ***JavaScript*** (and, by extension, ***TypeScript***) has a number of ways to access and work with ***API***.
  ...
  <Gist gistCode="2b192ecdd9213f18fca22b72c30fab2e" fileName="api-fetch.js" />
